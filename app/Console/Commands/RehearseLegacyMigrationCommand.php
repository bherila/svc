...
use App\Services\LegacyMigration\SyntheticMigrationRehearsal;
use App\Services\LegacyMigration\SyntheticMigrationRehearsalException;
use Illuminate\Console\Command;
use Throwable;

class RehearseLegacyMigrationCommand extends Command
{
    protected $signature = 'svc:migrate:legacy:rehearse
        {--format=text : Output text or json}';

    protected $description = 'Rehearse the legacy migration twice using disposable synthetic SQLite databases';

    public function handle(SyntheticMigrationRehearsal $rehearsal): int
    {
        ...
        } catch (SyntheticMigrationRehearsalException $exception) {

...
final class AgentMcpOutputSchemaFactory
{
    ...
    private function invoice(bool $detail = false): array
    {
        ...
        if ($detail) {
            $schema['properties']['lines'] = ['type' => 'array', 'items' => $this->object(['id' => $this->id(), 'project_id' => ['type' => ['string', 'null'], 'format' => 'uuid'], 'type' => ['type' => 'string'], 'description' => ['type' => 'string'], 'quantity' => ['type' => 'string'], 'unit_amount' => ['type' => 'integer'], 'tax_amount' => ['type' => 'integer'], 'total_amount' => ['type' => 'integer']], ['id', 'project_id', 'type', 'description', 'quantity', 'unit_amount', 'tax_amount', 'total_amount'])];

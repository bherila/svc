...
final class SourceGuard
{
    ...
    {
        $sources = Config::get('legacy-migration.sources', []);
    ...
    {
        $destinationName = Config::get('legacy-migration.destination_connection') ?: Config::get('database.default');
    ...
    {
        return 'legacy_migration_source_'.substr($source['identity_hash'], 0, 16);
    }

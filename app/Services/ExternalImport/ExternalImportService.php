...
final class ExternalImportService
{
    ...
    private static function importedDueDate(array $row): ?string
    {
        ...
        return in_array($status, ['issued', 'partially_paid', 'paid'], true)

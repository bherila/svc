 ...
 *
 * `cycle_start` and `cycle_end` are nullable, and SQL answers false for a null
 * rather than unknown, so a row missing either silently leaves every set that
 * compares them (#141). Whether that is safe depends on what the set is for,
 * and the three readings in #141 do not reduce to one default - which is why
 * this exists as a stated answer rather than a flag someone can forget.
 *

...
{
    public function store(Request $request, Workspace $workspace, string $project, ProjectAccess $access, AgentTaskPresenter $presenter): JsonResponse
    {
    ...
    public function update(Request $request, Workspace $workspace, string $task, ProjectAccess $access, AgentTaskPresenter $presenter): JsonResponse
    {
        ...
        return response()->json(['data' => $presenter->present($workspace, $record->fresh() ?? throw new \RuntimeException('The task no longer exists.'))]);
    }
